    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            List<Product> products = new List<Product>()
            {
                ...
                new Product() { PartNo = "A002", PartName = "大號一字螺絲起子" },
                new Product() { PartNo = "B001", PartName = "小號十字螺絲起子" },
                new Product() { PartNo = "B002", PartName = "大號十字螺絲起子" },
            };
